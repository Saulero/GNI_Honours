...
public final class SQLStatements {
    ...
    public static final String getIncomingTransactionHistory = "SELECT * FROM transactions_in WHERE transactions.destination_account = ?";
    public static final String getOutgoingTransactionHistory = "SELECT * FROM transactions_out WHERE transactions.source_account = ?";
