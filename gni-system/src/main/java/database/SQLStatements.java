...
public final class SQLStatements {
    ...
    public static final String addCreditCard = "INSERT INTO credit_cards (card_number, account_number, pin_code, credit_limit, balance, card_fee, active_from, active_until) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
