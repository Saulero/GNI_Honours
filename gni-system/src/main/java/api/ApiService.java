...
public final class ApiService {
        ...
        try {
            ...
            switch (method) {
                case "openAccount":             openAccountHandler(params, callbackBuilder, id);
                    break;
                case "openAdditionalAccount":   openAdditionalAccountHandler(params);
                    break;
                case "closeAccount":            closeAccountHandler(params);
                    break;
                case "provideAccess":           provideAccessHandler(params);
                    break;
                case "revokeAccess":            revokeAccessHandler(params);
                    break;
                case "depositIntoAccount":      depositIntoAccountHandler(params);
                    break;
                case "payFromAccount":          payFromAccountHandler(params);
                    break;
                case "transferMoney":           transferMoneyHandler(params);
                    break;
                case "getAuthToken":            getAuthTokenHandler(params);
                    break;
                case "getBalance":              getBalanceHandler(params);
                    break;
                case "getTransactionsOverview": getTransactionsOverviewHandler(params);
                    break;
                case "getUserAccess":           getUserAccessHandler(params);
                    break;
                case "getBankAccountAccess":    getBankAccountAccessHandler(params);
                    break;
    ...
    private void openAdditionalAccountHandler(final Map<String, Object> params) {
    ...
    private void closeAccountHandler(final Map<String, Object> params) {
    ...
    private void provideAccessHandler(final Map<String, Object> params) {
    ...
    private void revokeAccessHandler(final Map<String, Object> params) {
    ...
    private void depositIntoAccountHandler(final Map<String, Object> params) {
        // can be implemented 1:1 with a pin transaction.
    }
    private void payFromAccountHandler(final Map<String, Object> params) {
        // can be implemented 1:1 with a pin transaction.
    }
    private void transferMoneyHandler(final Map<String, Object> params) {
        // can be implemented 1:1 with a normal transaction request.
    }
    private void getAuthTokenHandler(final Map<String, Object> params) {
        // can be implemented 1:1 with do login.
    }
    private void getBalanceHandler(final Map<String, Object> params) {
        // can be implemented 1:1 with get request.
    }
    private void getTransactionsOverviewHandler(final Map<String, Object> params) {
        // can be implemented 1:1 with get request, needs some more parsing in api.
    }
    private void getUserAccessHandler(final Map<String, Object> params) {
        // can be implemented 1:1 with get request.
    }
    private void getBankAccountAccessHandler(final Map<String, Object> params) {
