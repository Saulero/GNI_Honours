...
public final class UIService {
    ...
    /**
     * Send a transaction request to the ledger service that will reply with the transaction history of the account.
     * @param accountNumber Account number to request the transaction history for.
     */
     ...
     * @param dataReply Reply object containing the type of request and its reply data
     */
     ...
     * @param destinationAccountHolderName The name of the owner of the destination account number
     * @param transactionNumber Transaction number used for processing
     */
    //TODO generate transaction number in ledger, process reply
    public void doTransaction(final String sourceAccountNumber, final double amount, final String
            destinationAccountNumber, final String destinationAccountHolderName, final long transactionNumber) {
        //Do transaction work
    ...
    /**
     * Send a user creation request over the USER_CREATION_CHANNEL to create a new user in the system
    ...
    public void createCustomer(final String name, final String surname, final String accountNumber) {
